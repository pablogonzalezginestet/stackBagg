...
````{r}
pred_discard <- ensBagg::prediction_discard(train.data = train,test.data = test,xnam = xnam,tao = 26.5)
head(pred_discard$prediction_discard)
pred_discard$auc_discard
````
