...
**stackBagg** provides the files to reproduce the simulation studies and the real data application in the paper accepted for publication in the Journal of the Royal Statistical Society (Series C):
